...
kx = '\ensuremath{\kappa_{\mathrm{\scriptscriptstyle X}}}';
ky = '\ensuremath{\kappa_{\mathrm{\scriptscriptstyle Y}}}';
omf = '\ensuremath{\Omega}';
omx = '\ensuremath{\Omega_1}';
omy = '\ensuremath{\Omega_2}';

pairs = {
'\x', '\ensuremath{\mathbf{x}}';
'\y', '\ensuremath{\mathbf{y}}';
'\Ex', '\ensuremath{\mathrm{E}}'; % \mathsf fails
'\usym', '\ensuremath{\kappa}';

...
public class SimpleTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        ListSet listUT = new FineGrainedListSet();
        ...
        //TODO: not testing orders of the list
...
class TestRunner implements Runnable {
    ...
    public TestRunner(ListSet linkedList, BagValues bagValues, OperationType op, int numRun) {
        this.sut = linkedList;
        this.op = op;
